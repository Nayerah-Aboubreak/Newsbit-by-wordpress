 ...
 */
class frannawp_Category_Three_Right_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'category_3_right_widget', // Base ID
			esc_html__( 'Category 3 Posts ( Right )', 'frannawp' ), // Name
	...
	public function widget( $args, $instance ) {
        ...
        $args_post_three_right_top = array(
            'posts_per_page'      => 1,
            'post_type'           => 'post'
        );
        ...
        if ( $type == 'category' ) {
            $args_post_three_right_top['category__in'] = $category;
        }

        $post_cat_three_right_top   =   new WP_Query( $args_post_three_right_top );
    ?>

    <!-- Widget Category 3 Post Starts -->

    <div class="widget-category-three-right">

        <?php while( $post_cat_three_right_top->have_posts() ): $post_cat_three_right_top->the_post(); ?>

            <?php $post_one =   $post->ID; ?>
            
            <div class="widget-category-three-right-top">
        ...
        <?php
            ...
            $args_post_three_right_bottom    = array(
            ...
            // Display from chosen category.
            if ( $type == 'category' ) {
                $args_post_three_right_bottom['category__in'] = $category;
            }

            $post_cat_three_right_bottom   =   new WP_Query( $args_post_three_right_bottom );

        ?>

        <div class="widget-category-three-right-bottom">

            <?php while( $post_cat_three_right_bottom->have_posts() ): $post_cat_three_right_bottom->the_post(); ?>
    ...
    </div><!-- .widget-category-three-right -->
